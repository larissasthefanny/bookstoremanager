...
public class BookstoreExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> hamdleEntityNotFoundException(EntityNotFoundException exception){
    ...
    private ResponseEntity<Object> buildResponseEntity(HttpStatus httpStatus, String messageError, List<String> errors) {
